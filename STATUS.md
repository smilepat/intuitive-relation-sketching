...
## 🎯 한 줄 상태
M6a 완료 — 마우스 대안 1탄: 기호 스탬프 + 관계 템플릿. 타입검사·빌드 통과. 브라우저 수동 검증 대기.
...
- [ ] 브라우저에서 M1~M4·M6a 기능 수동 확인  ← 현재 위치
- [ ] GitHub Pages 활성화 (Settings → Pages → Source: GitHub Actions)
- [ ] M6b: 문장 단어 칩 / M6c: 노드-엣지 모델 / M6d: 키보드+스냅

## ⏭️ 다음에 할 일 (Next Actions)
1. `npm run dev`로 실행: 스탬프 원클릭 배치, 관계 템플릿 삽입(undo 1회) 확인
